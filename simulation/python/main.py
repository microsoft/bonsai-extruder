...
class ExtruderSimulation(SimulatorSession):
    def reset(
        ...
        self.efficiency = 0
        #self.parts_per_iteration = model.parts_per_iteration
    ...
    def step(self):
        ...
        self.efficiency = self.parts_on_spec/self.total_parts
    ...
    def get_state(self):
        return {
            ...
            "parts_on_spec": self.parts_on_spec,
            "parts_per_iteration": self.parts_per_iteration
        }
