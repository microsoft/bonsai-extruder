...
class linear_mpc:
    def __init__(self, ω0_s,f0_c,Δω0_s,Δf0_c, noise):
        ...
        c = [ 4.47418965e-01,  2.49424850e-01, -7.76219127e+00,  1.10659049e-06,
         -1.31921461e+00,  3.79914896e+01, -9.49465660e-08 , 1.23113764e-06,
          2.03070846e+00, -5.51802001e+01]
        self.c = c
        m.Equation([m.L + m.L.dt() == c[0] + c[1]*m.w_s + c[2]*m.f_c + c[3]*m.w_s**2 + c[4]*m.f_c*m.w_s + c[5]*m.f_c**2 + c[6]*m.w_s**3 + c[7]*m.f_c*m.w_s**2 + c[8]*m.w_s*m.f_c**2 + c[9]*m.f_c**3]) #NLMPC Poly
        ...
        m.options.CV_TYPE = 1 # the objective is an l2-norm (squared error) 
